...
/**
 * Count today's takeaway orders to generate the next queue number.
 * @returns {Promise<number>} Next queue number (1-based)
 */
export async function getTodayTakeawayCount() {
